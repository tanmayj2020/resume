%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%Go to overleaf.com for editing this document. 
%Tex Maker does not work
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\subsection{Coding Ninjas}
\descript{Competitive Coding in C++}
\location{2020 | Online \\ Top Performer}
\descript{Full Stack Web Development}
\location{2020-2021 | Online \\ Top Performer}
...
\location{Dec 2019 - Present | New Delhi}
\vspace{\topsep}
\begin{tightitemize}
...
% \location{Nov 2020 - Jan 2020 | Online}
% \begin{tightitemize}
% \item Mentored a batch of 20 students in Web Development
% \item Worked with NodeJS and ReactJS libraries
% \end{tightitemize}
